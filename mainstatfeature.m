...
no_of_images = 200; % Number of Images to consider for computation
model_frame_no = 800; % Begin Frame Number for a dataset
...
Tb = 0.5; % Weight Threshold
alpha = 0.09; % Learning Rate

% Must Be Odd Values
siz_kr = 3; % Size of Kernel for parsing each pixel in the Image Matrix in "lh_le_cal" function
...
covar_mat_mf = zeros(3,3,siz_X(1),siz_X(2),no_of_model_frames); % Covariance matrix
